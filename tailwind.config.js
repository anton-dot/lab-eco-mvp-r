...
module.exports = {
  ...
  theme: {
    extend: {
      backgroundImage: {
        "custom-gradient":
          "var(--background, linear-gradient(135deg, #414595 0%, #00022F 100%))",
      },
      colors: {
